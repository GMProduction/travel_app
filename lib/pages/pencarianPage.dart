...
import 'package:travel_apps/dataTravel.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: GenText("Hasil Pencarian", fontSize: 15, fontweight: FontWeight.bold, color: Colors.black,),
                  ),
                  SizedBox(height: 15,),
                  Column(children: DataTravel.data.map<Widget>((e) {
                        return InkWell(
                          onTap: (){
                            Get.toNamed("/detail", arguments: {'url_gambar': e["url_gambar"], 'namapaket': e["namapaket"],
                              "lokasi": e["lokasi"],
                              "deskripsi": e["deskripsi"],
                              "durasi": e["durasi"],
                              "harga": e["harga"],
                              "daftartour": e["daftar-tour"],
                            });
                          },
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        GenText(formatRupiahUseprefik(e["harga"]), fontSize: 12, fontweight: FontWeight.bold, color: GenColors.primaryColor,),
                                      ],
                                    ),
                                  ],
                                ),
